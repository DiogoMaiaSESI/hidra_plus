...
<body>
    ...
    <figure class="logotipo">
        <img src="../templates/assets/img/logoHidraPlus.png"
            alt="Logo para HIDRA Plus com gotas de água estilizadas em azul dispostas em um padrão circular com o texto HIDRA Plus abaixo em fonte moderna e negrito em um fundo branco, transmitindo uma atmosfera fresca e acolhedora">
    </figure>
    <div class="conteudo-principal">
        <div class="informacoes">
            ...
            <figure class="estrelas">
                <img src="../templates/assets/img/stars.png"
                    alt="Cinco estrelas amarelas espaçadas uniformemente em uma linha em um fundo transparente, representando uma classificação de cinco estrelas, transmitindo um tom positivo e acolhedor">
            </figure>
        </div>
        <form method="POST">
